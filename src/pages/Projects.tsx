...
export const projects: Project[] = [
  {
    ...
    tech: ["Flutter", "Fastlane", "Nest.js", "Next.js", "Cloudflare Images", "Mantine UI", "Supabase"],
    links: {
...
친환경 소비에 대한 정보와 팁을 제공하여 사용자들의 환경 의식을 높이는 데 기여하고 있습니다.
  ...
  },
  {
    ...
    image: nightaryImg,
    tech: ["Flutter", "HealthKit", "Local Storage", "WidgetKit"],
    links: {
...
- HealthKit을 통한 실제 수면 데이터를 분석해보니 수면 데이터가 연속적이지 않고, 
    `,
    features: [
...
학교 공식 API 및 웹크롤링을 통해 최신 정보를 제공하며, 강의평가, 학교 시설 예약, 동아리 정보 등 학생들의 캠퍼스 라이프를 더욱 편리하게 만들어주는 다양한 기능을 지속적으로 개발하고 있습니다.
    `,
    features: [
      "실시간 학사 일정 및 공지사항 알림",
      "강의 정보 검색 및 강의평가",
...
어렵지 않은 기술로 많은 사람들에게 도움을 주기 위해서 만들게 되었습니다.
  ...
  },
  {
    ...
    tech: ["Flutter Web", "JavaScript", "local storage"],
    links: {
