...
또한 <strong class='text-[#61dafb]'>AI</strong>를 적극적으로 활용하여 Product에 빠르게 <strong class='text-[#61dafb]'>비즈니스 임팩트</strong>를 낼 수 있는 방안을 항상 고민하고 적극적으로 제시하는 <strong class='text-[#61dafb]'>Product Engineer</strong>입니다.`;
  ...
  return (
    <>
      <Meta
        title="이력서 | 심상현"
        description="심상현의 전문 개발 이력서입니다. 풀스택 개발, 플러터 애플리케이션 개발, UI/UX 디자인 등의 경험을 소개합니다."
      />
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="min-h-screen pt-20 pb-20 px-4 max-w-4xl mx-auto">
        {/* 헤더 섹션 */}
        <motion.header
